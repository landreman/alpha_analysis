> **Historical archive; nonnormative.** The original 2026-09-03 proposal is preserved verbatim below. Its recommendations, likelihood estimates, and Appendix A pilot claims are historical evidence, not the active implementation plan or verified acceptance results. Use [the review disposition](../2026-09-03-algorithm-redesign.md), [the active design](../DESIGN.md), and accepted ADR 0010 for current work.
