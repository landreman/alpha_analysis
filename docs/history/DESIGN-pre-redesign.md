> Historical snapshot, 2026-09-11, from PR #24 head c11fb30.
> Superseded for new development by [the active design](../DESIGN.md) and
> [ADR 0010](../adr/0010-branch-atlas-and-bounded-f.md).
> Old milestone instructions below are evidence, not the active work queue.
