...
- Milestone 5's common extractor contract runs against both marching tetrahedra and real PyVista/VTK in CI; PyVista seam copies are matched one-to-one before merging and intentionally retain `-1` provenance IDs.
