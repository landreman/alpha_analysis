...
Baseline: `ff3bfecd3d78302aecb3b5549fdb918b4a11ef6a`. Code SHA256: `4c70486e493f787e62d9a3a4bd8448e316d4bb282400c4032a5c1734e4dbd2b4`.
...
Measured shared scan+query: 1.763 s across both grids and all pitches; fresh catalogue scan+query per pitch: 8.310 s (4.71x cost ratio).
...
| --- | ---: | --- | ---: | --- | ---: | ---: | ---: |
| 0 | 0.05 | coarse | 0 | REGULAR | 0 | 0.183 | 0.011 |
| 0 | 0.1 | coarse | 0 | REGULAR | 0 | 0.183 | 0.006 |
| 0 | 0.5 | coarse | 2 | MAX_PERIODS | 0 | 0.183 | 0.033 |
| 0 | 0.8 | coarse | 1 | MAX_PERIODS | 0 | 0.183 | 0.073 |
| 0 | 0.9 | coarse | 0 | MAX_PERIODS | 0 | 0.183 | 0.003 |
| 0 | 0.95 | coarse | 0 | MAX_PERIODS | 0 | 0.183 | 0.003 |
| 0 | 0.05 | fine | 0 | REGULAR | 0 | 0.206 | 0.035 |
| 0 | 0.1 | fine | 0 | REGULAR | 0 | 0.206 | 0.041 |
| 0 | 0.5 | fine | 2 | MAX_PERIODS | 0 | 0.206 | 0.033 |
| 0 | 0.8 | fine | 1 | MAX_PERIODS | 0 | 0.206 | 0.033 |
| 0 | 0.9 | fine | 0 | MAX_PERIODS | 0 | 0.206 | 0.006 |
| 0 | 0.95 | fine | 0 | MAX_PERIODS | 0 | 0.206 | 0.016 |
| 1 | 0.05 | coarse | 0 | REGULAR | 0 | 0.120 | 0.006 |
| 1 | 0.1 | coarse | 0 | REGULAR | 0 | 0.120 | 0.003 |
| 1 | 0.5 | coarse | 2 | MAX_PERIODS | 0 | 0.120 | 0.011 |
| 1 | 0.8 | coarse | 1 | MAX_PERIODS | 0 | 0.120 | 0.018 |
| 1 | 0.9 | coarse | 0 | MAX_PERIODS | 0 | 0.120 | 0.003 |
| 1 | 0.95 | coarse | 0 | MAX_PERIODS | 0 | 0.120 | 0.003 |
| 1 | 0.05 | fine | 0 | REGULAR | 0 | 0.143 | 0.007 |
| 1 | 0.1 | fine | 0 | REGULAR | 0 | 0.143 | 0.006 |
| 1 | 0.5 | fine | 2 | MAX_PERIODS | 0 | 0.143 | 0.016 |
| 1 | 0.8 | fine | 1 | MAX_PERIODS | 0 | 0.143 | 0.013 |
| 1 | 0.9 | fine | 0 | MAX_PERIODS | 0 | 0.143 | 0.006 |
| 1 | 0.95 | fine | 0 | MAX_PERIODS | 0 | 0.143 | 0.006 |
| 2 | 0.05 | coarse | 4 | REGULAR | 0 | 0.071 | 0.027 |
| 2 | 0.1 | coarse | 4 | REGULAR | 0 | 0.071 | 0.015 |
| 2 | 0.5 | coarse | 4 | REGULAR | 0 | 0.071 | 0.015 |
| 2 | 0.8 | coarse | 4 | REGULAR | 0 | 0.071 | 0.029 |
| 2 | 0.9 | coarse | 1 | MAX_PERIODS | 0 | 0.071 | 0.012 |
| 2 | 0.95 | coarse | 0 | MAX_PERIODS | 0 | 0.071 | 0.003 |
| 2 | 0.05 | fine | 4 | REGULAR | 0 | 0.152 | 0.024 |
| 2 | 0.1 | fine | 4 | REGULAR | 0 | 0.152 | 0.021 |
| 2 | 0.5 | fine | 4 | REGULAR | 0 | 0.152 | 0.019 |
| 2 | 0.8 | fine | 4 | REGULAR | 0 | 0.152 | 0.027 |
| 2 | 0.9 | fine | 1 | MAX_PERIODS | 0 | 0.152 | 0.042 |
| 2 | 0.95 | fine | 0 | MAX_PERIODS | 0 | 0.152 | 0.006 |
| 3 | 0.05 | coarse | 3 | REGULAR | 0 | 0.079 | 0.017 |
| 3 | 0.1 | coarse | 3 | REGULAR | 0 | 0.079 | 0.015 |
| 3 | 0.5 | coarse | 3 | MAX_PERIODS | 0 | 0.079 | 0.018 |
| 3 | 0.8 | coarse | 0 | MAX_PERIODS | 0 | 0.079 | 0.011 |
| 3 | 0.9 | coarse | 0 | MAX_PERIODS | 0 | 0.079 | 0.005 |
| 3 | 0.95 | coarse | 0 | NO_WELL | 0 | 0.079 | 0.000 |
| 3 | 0.05 | fine | 3 | REGULAR | 0 | 0.193 | 0.035 |
| 3 | 0.1 | fine | 3 | REGULAR | 0 | 0.193 | 0.021 |
| 3 | 0.5 | fine | 3 | MAX_PERIODS | 0 | 0.193 | 0.032 |
| 3 | 0.8 | fine | 0 | MAX_PERIODS | 0 | 0.193 | 0.007 |
| 3 | 0.9 | fine | 0 | MAX_PERIODS | 0 | 0.193 | 0.006 |
| 3 | 0.95 | fine | 0 | NO_WELL | 0 | 0.193 | 0.000 |
| 4 | 0.05 | coarse | 0 | REGULAR | 0 | 0.074 | 0.002 |
| 4 | 0.1 | coarse | 0 | REGULAR | 0 | 0.074 | 0.003 |
| 4 | 0.5 | coarse | 0 | MAX_PERIODS | 0 | 0.074 | 0.003 |
| 4 | 0.8 | coarse | 0 | MAX_PERIODS | 0 | 0.074 | 0.003 |
| 4 | 0.9 | coarse | 0 | MAX_PERIODS | 0 | 0.074 | 0.002 |
| 4 | 0.95 | coarse | 0 | NO_WELL | 0 | 0.074 | 0.000 |
| 4 | 0.05 | fine | 0 | REGULAR | 0 | 0.100 | 0.005 |
| 4 | 0.1 | fine | 0 | REGULAR | 0 | 0.100 | 0.013 |
| 4 | 0.5 | fine | 0 | MAX_PERIODS | 0 | 0.100 | 0.006 |
| 4 | 0.8 | fine | 0 | MAX_PERIODS | 0 | 0.100 | 0.004 |
| 4 | 0.9 | fine | 0 | MAX_PERIODS | 0 | 0.100 | 0.004 |
| 4 | 0.95 | fine | 0 | NO_WELL | 0 | 0.100 | 0.000 |
...
- 1: `boozmn_20260402-01-178_TURBO_Garabedian_mpol1_xmin0p1_allNfp_aspect6_eval000155.nc` SHA256 `ec583795826f7b9cb213d0c63977ecc03b1e72e98bcc53de9a0621f17934202e`; load 0.013 s
