...
> **Disposition, 2026-09-11:** The researcher approved the branch-atlas and
> bounded-\(f\) path in ADR 0010. This proposal is superseded for that path;
> its legacy endpoint/cut implementation is not retroactively accepted. The
> original proposal below is retained as historical evidence. Its "Left for
> the researcher" decision text and milestone-10.3 instructions describe the
> earlier proposal, not a pending decision or the active implementation plan.
