...
- **Status:** Superseded by [ADR 0010](0010-branch-atlas-and-bounded-f.md)
- **Date:** 2026-08-31
- **Milestone:** 10.3
- **Design sections:** §23 milestone 10.3 (goal and acceptance), §21.2, §21.3;
  ADRs 0006–0008

> **Disposition, 2026-09-11:** ADR 0010 replaces the active implementation and
> acceptance policy. The recorded 42/120 (35%) result remains a failure of
> milestone 10.3; it is not accepted as a successful result or relabeled
> resolved. The original proposal below remains historical evidence. Its
> pending-decision language and directions to retain the old policy test
> describe the earlier branch; ADR 0010 governs selective salvage and the new
> tests. Cap exhaustion in that implementation is not a proof that a different
> algorithm cannot compute the metric.
